...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Authenticator Test];
    [[Authenticator sharedManager] authenticateWithLicense:LICENSE forDefaults:[NSUserDefaults standardUserDefaults] aFBShareLink:FBShareLink aFBShareText:FBShareText FeebBackEmail:FeedBackEmail aFeedbackSubject:FeedbackSubject aLevReq1:[@(LevelRequirementForSlotNumber1) stringValue] aLevReq2:[@(LevelRequirementForSlotNumber2) stringValue] aLevReq3:[@(LevelRequirementForSlotNumber3) stringValue] aLevReq4:[@(LevelRequirementForSlotNumber4) stringValue] aLevReq5:[@(LevelRequirementForSlotNumber5) stringValue] aBundleID:[[NSBundle mainBundle] bundleIdentifier] aTwitterShareText:TwitterShareText aTwitterShareLink:twitterShareLink];
...
//    [BBXBeeblex initializeWithAPIKey:@""];
    ...
    id<GAITracker> tracker = [[GAI sharedInstance] trackerWithTrackingId:GoogleAnalyticsTrackingID];
