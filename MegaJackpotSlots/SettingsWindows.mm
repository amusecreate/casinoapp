...
-(void)labels
{
    ...
    b6luxLabel          = [CCLabelBMFont labelWithString:@"Apprinciples Corporation" fntFile:kFONT_SETTINGS];
    ...
    eLabel          = [CCLabelBMFont labelWithString:@"Apprinciples Corporation" fntFile:kFONT_SETTINGS];
