...
-(void)labels
{
    ...
    b6luxLabel          = [CCLabelBMFont labelWithString:@"Shooterboy Entertainment" fntFile:kFONT_SETTINGS];
    ...
    eLabel          = [CCLabelBMFont labelWithString:@"Shooterboy Entertainment" fntFile:kFONT_SETTINGS];
