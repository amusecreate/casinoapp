...
//    [[CCSpriteFrameCache sharedSpriteFrameCache] removeSpriteFramesFromFile:[NSString stringWithFormat:@"bg0_1.plist"]];
...
//    [[CCSpriteFrameCache sharedSpriteFrameCache] removeSpriteFramesFromFile:[NSString stringWithFormat:@"bg1_1.plist"]];
...
//    CCSpriteBatchNode *bg0 = [CCSpriteBatchNode batchNodeWithFile:[NSString stringWithFormat:@"bg0_1.pvr.ccz"]];
...
//    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:[NSString stringWithFormat:@"bg0_1.plist"]];
...
//    CCSpriteBatchNode *bg1 = [CCSpriteBatchNode batchNodeWithFile:[NSString stringWithFormat:@"bg1_1.pvr.ccz"]];
...
//    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:[NSString stringWithFormat:@"bg1_1.plist"]];
